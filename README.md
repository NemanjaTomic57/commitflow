...
![Commit Activity Dashboard](docs/images/CommitsOverTime.png)

---

### Commits Per Provider
...
![Commits Per Provider](docs/images/CommitsPerProvider.png)
...
![Commits Per Repository](docs/images/CommitsPerRepository.png)
